...
#Start-Process -file 'C:\MicrosoftEdgeSetup.exe' -arg '/qn /l*v C:\edge_install.txt' -passthru | wait-process
...
Expand-Archive -LiteralPath "C:\MCW\icw-app-mod-$branchName\Hands-on-lab\lab-files\web-deploy-files.zip" -DestinationPath 'C:\inetpub\wwwroot' -Force
...
Copy-Item "C:\MCW\icw-app-mod-$branchName\Hands-on-lab\lab-files\src\src\PartsUnlimitedWebsite\config.json" -Destination 'C:\inetpub\wwwroot' -Force
